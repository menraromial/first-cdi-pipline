...
# Télécharger et convertir la clé en format GPG
curl -fsSL https://pkgs.k8s.io/core:/stable:/v$KUBERNETES_VERSION/deb/Release.key | gpg --dearmor | sudo tee /etc/apt/keyrings/kubernetes-apt-keyring.gpg > /dev/null

# Ajouter le dépôt Kubernetes à la liste des sources apt
...
# Configurer les arguments supplémentaires pour kubelet
